      ...
      <div className="min-h-screen max-w-7xl mx-auto flex items-center justify-center text-white px-4 sm:px-6">
        ...
        <div className="bg-gray-900 p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-md mt-24 sm:mt-20">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 text-center">
            Welcome to <span className="text-orange-500">SkillCart</span>
          </h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="email" className="text-gray-400 text-sm sm:text-base mb-2 block">
                Email
              </label>
            ...
            <div className="mb-4">
              <label htmlFor="password" className="text-gray-400 text-sm sm:text-base mb-2 block">
                Password
              </label>
